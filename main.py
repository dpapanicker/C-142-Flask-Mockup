# this is the 4th and final program to do ...almost same as class 141
...
def recommended_movies():
    ...
    import itertools # Python's Itertool is a module that provides various 
    # functions that work on iterators to produce complex iterators. This module 
    # works as a fast, memory-efficient tool that is used either by themselves or
    #  in combination to form iterator algebra.
